...
struct ResTpFrames {
	...
	xx::Ref<xx::Frame> eye_fire_1;
	xx::Ref<xx::Frame> eye_fire_2;
	xx::Ref<xx::Frame> eye_fire_3;
	xx::Ref<xx::Frame> eye_fire_4;
	xx::Ref<xx::Frame> eye_fire_5;
	xx::Ref<xx::Frame> eye_fire_6;
	xx::Ref<xx::Frame> eye_fire_7;
	...
	xx::Ref<xx::Frame> staff_5;
	xx::Ref<xx::Frame> sword_16;

	xx::Listi32<xx::Ref<xx::Frame>> explosion_13_;
	static constexpr int32_t _countof_explosion_13_ { 7 };
	xx::Listi32<xx::Ref<xx::Frame>> eye_fire_;
	static constexpr int32_t _countof_eye_fire_ { 7 };
	...
	static constexpr int32_t _countof_monster_ { 4 };
	xx::Listi32<xx::Ref<xx::Frame>> staff_;
	static constexpr int32_t _countof_staff_ { 1 };
	xx::Listi32<xx::Ref<xx::Frame>> sword_;
	static constexpr int32_t _countof_sword_ { 1 };
};
