...
var za,
  ...
  Qa = {
    ...
    Z: (a, b, c, d) => Fa(a, b, c, d, 2, "keydown"),
    T: (a, b, c, d) => Fa(a, b, c, d, 3, "keyup"),
    O: (a, b, c, d) => Ga(a, b, c, d, 5, "mousedown"),
    M: (a, b, c, d) => Ga(a, b, c, d, 8, "mousemove"),
    N: (a, b, c, d) => Ga(a, b, c, d, 6, "mouseup"),
    ka: (a, b) => {
      b >>= 2;
      b = {
        alpha: !!y[b],
