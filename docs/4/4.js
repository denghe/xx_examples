...
var Y,
  sb = {
    ...
    ba: (a, b, c, d) => Ua(a, b, c, d, 2, "keydown"),
    U: (a, b, c, d) => Ua(a, b, c, d, 3, "keyup"),
    M: (a, b, c, d) => Va(a, b, c, d, 5, "mousedown"),
    K: (a, b, c, d) => Va(a, b, c, d, 8, "mousemove"),
    L: (a, b, c, d) => Va(a, b, c, d, 6, "mouseup"),
  ...
  Q = a => (Q = Z.ra)(a),
  Za = a => (Za = Z.sa)(a),
  tb = g._main = (a, b) => (tb = g._main = Z.ta)(a, b),
  ub;
E = function vb() {
  ub || wb();
  ub || (E = vb);
